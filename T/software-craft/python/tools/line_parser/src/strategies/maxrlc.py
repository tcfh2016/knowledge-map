...
class MaxRlc(strategy.Strategy):
    ...
    def construct_head_line(self):
        head_line = "BearGroup," + "BearIndex," + "UeId," + "UeIdCu," + "LodataUeId," + "LogicalChannelId\n"
        return head_line
    ...
    def doParse(self, line):
        ...
        output_line = str(BearGroup) + "," + str(BearIndex) + "," + str(UeId) + "," + str(UeIdCu) + "," + str(LodataUeId) + "," + str(LogicalChannelId) + "\n"
        print (output_line)
        return output_line
